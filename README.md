...
A me l'interfaccia di VS non piace molto, quindi ho testato anche l'IDE di Processing.
* **Ambiente:**[Processing](https://processing.org/) in modalita p5js,
  * **Setup:**
    1. Installa le dipendenze: `npm install osc`.
    2. Avvia il server: `node server.js` (o usa i file `.bat` inclusi).
    3. Avvia lo sketch tramite *Live Server* su VS Code.
...
Funziona molto bene, ma non è ancora capace di rilevare errori... quindi il debug è un po' difficile.  
